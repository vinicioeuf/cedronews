                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="card-title h4">Secretaria de Saúde irá começar a vacinação com crianças de 1 a 2 anos contra Covid-19</h2>
                                    <p class="card-text">O cuidado com a saúde das nossas crianças é prioridade. Por isso, a gestão municipal está iniciando a vacinação de crianças de 1 a 2 anos contra a Covid-19. .</p>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="small text-muted">16 de Janeiro, 2023</div>
                                    <h2 class="card-title h4">Próximo ao inicio do ano letivo de 2023, as escolas públicas de cedro tem matriculas abertas até o dia 20 de Janeiro, nesta sexta.</h2>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="card-title h4">Segunda rodada do campeonato dos viajantes acontece no próximo domingo.</h2>
                                    <p class="card-text">Segue o mata mata com mais de 40 times no Águas Park paraiso dos amigos.</p>
                                    <a class="btn btn-primary" href="#!">Continuar lendo →</a>
                                </div>
                            </div>
                            <!-- Blog post-->
